...
def PmfOfWaitTime(pmf_zb):
    ...
    pmf_y = thinkstats2.MakeMixture(metapmf, label='y')
    return pmf_y
...
class ArrivalRate(thinkstats2.Suite):
...
class Elapsed(thinkstats2.Suite):
...
class GapDirichlet(thinkstats2.Dirichlet):
    ...
    def __init__(self, xs):
        ...
        """
        n = len(xs)
        thinkstats2.Dirichlet.__init__(self, n)
        self.xs = xs
        self.mean_zbs = []
    ...
    def PmfMeanZb(self):
        ...
        """
        return thinkstats2.Pmf(self.mean_zbs)
    ...
    def Preload(self, data):
        ...
        """
        thinkstats2.Dirichlet.Update(self, data)
...
class GapTimeEstimator(object):
    ...
    def __init__(self, xs, pcounts, passenger_data):
        ...
        self.pmf_y = thinkstats2.Pmf(self.wait_times, label="y")
...
class WaitMixtureEstimator(object):
    ...
    def __init__(self, wtc, are, num_passengers=15):
        ...
        """
        self.metapmf = thinkstats2.Pmf()

        for lam, prob in sorted(are.post_lam.Items()):
            ete = ElapsedTimeEstimator(wtc, lam, num_passengers)
            self.metapmf.Set(ete.pmf_y, prob)

        self.mixture = thinkstats2.MakeMixture(self.metapmf)
